        ...
        <div class="container-fluid">
              <table id="myTable">
                <thead>
                  ...
                  <tbody>
                  @foreach($gradesPeriods as $value)
                        <tr>
                            ...
                            <td class="text-center">
                                @if($value->status == 0)
                                    <a href="{{ url('faculty/grading/enabled'.$value->class_period_id) }}" class="btn btn-success btn-sm">Enable</a>
                                @else
                                    <a href="{{ url('faculty/grading/disabled'.$value->class_period_id) }}" class="btn btn-danger btn-sm">Disable</a>
                                @endif
                            </td>
                        </tr>
                    @endforeach
