            ...
            <main class="content px-3 py-2">
                ...
                <table class="table table-striped">
                  ...
                  @foreach ($classes as $classCount)
                        <tr>
                        <td class="text-center">{{ $classCount->name }}</td>
                        <td class="text-center">{{ $classCount->section }}</td>
                        <td class="text-center">{{ $classCount->students_count }} Students</td>
                        <td class="text-center"> 
                      <a href="#" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#ModalEdit{{$classCount->class_id}}"><i class="fa-regular fa-eye p-1" style="color: #fafafa;"></i>View List</a>
                      <!-- <a href="#" class="btn btn-success btn-sm"</i>Download Class List</a> -->
                      </td>
                        </tr>
                        @include('faculty/class_list/modal_view_student')
                    @endforeach
                    </tbody>
                </table>
                <!-- pagination -->
