        ...
        <div class="main">
            ...
            <main class="content px-3 py-2">
                ...
                <div class="row">
                      ...
                      <div class="col-2">
                          <select class="form-select" name="type" placeholder="Select Type">
                              <option>Select Type</option>
                              <option value="JHS" {{ old('type') == 'JHS' ? 'selected' : '' }}>JHS</option>
                              <option value="SHS" {{ old('type') == 'SHS' ? 'selected' : '' }}>SHS</option>
                          </select>
                          <span style="color:red; font-size:10px; padding:0; margin:0;">@error('type'){{ $message }} @enderror</span>
                      </div>
