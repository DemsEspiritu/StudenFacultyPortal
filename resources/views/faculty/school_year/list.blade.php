 ...
 <li class="sidebar-item">
        ...
        <div class="main">
            ...
            <main class="content px-3 py-2">
                ...
                <table class="table m-2 table-striped" id="myTable">
                    <thead>
                    <tr>
                  ...
                  @foreach($school_year as $year)
                    <tr>
                        ...
                        <td class="text-center {{$year->status == 1 ? 'text-success' : 'text-danger'}}">
                            {{$year->status == 1 ? 'Active' : 'Inactive'}}
                        </td>
                        <td class="text-center"> 
                            <a href="{{ url('faculty/school_year/edit'.$year->school_year_id) }}" class="btn btn-primary btn-sm">
                                <i class="fa-regular fa-pen-to-square p-1" style="color: #fafafa;"></i>Edit
                            </a>

                            @if($year->status == 1)
                                <a href="{{ url('faculty/school_year/disable'.$year->school_year_id) }}" class="btn btn-danger btn-sm">
                                <i class="fa-solid fa-x "></i><span>  </span>Disable
                                </a>
                            @else
                                <a href="{{ url('faculty/school_year/enable'.$year->school_year_id) }}" class="btn btn-success btn-sm">
                                <i class="fa-solid fa-check"></i><span>  </span>Enable
                                </a>
                            @endif
                        </td>
                    </tr>
